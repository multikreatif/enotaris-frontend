...
export function TimelineItem({
  ...
  return (
    <div className="flex items-start relative overflow-visible">
      {line && (
        <div className="w-9 start-0 top-9 absolute -bottom-4 rtl:-translate-x-1/2 translate-x-1/2 border-s border-s-input"></div>
      )}
